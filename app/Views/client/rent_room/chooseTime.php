                    ...
                    <div class="tab-pane fade show active" id="tab-2" role="tabpanel" aria-labelledby="2-tab" tabindex="0">
                        <form action="" method='post' id="chooseTime">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12 d-flex flex-column justify-content-center align-items-left row">
                                    <div class="bg-light m-1">
                                        ...
                                        <?php if (isset($error['check_pay'])) { ?>
                                            <span class="text-danger"><b><?php echo $error['check_pay'] ?></b></span>
                                        <?php } ?>
                                    </div>
