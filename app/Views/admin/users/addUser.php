					...
					<div class="row">
							...
							<div class="row">
								<div class="col-12" style="margin-top: 15px">
									<div class="sign__group">
										<input type="text" class="sign__input" placeholder="Họ tên" name="fullname"
						...
						<div class="col-12 col-xl-5">
							<div class="row">
								<div class="col-12" style="margin-top: 15px">
									<div class="sign__group">
										<input type="number" class="sign__input" placeholder="Số điện thoại"
											name="phone"
								...
								<div class="col-12" style="margin-top: 15px">
									<div class="sign__group">
										<input type="date" class="sign__input" placeholder="Ngày sinh" name="birthday"
						...
						<div class="col-12">
							<input type="submit" value="Thêm người dùng" class="sign__btn sign__btn--small"
								name="addUser">
						</div>
					</div>
				</form>
