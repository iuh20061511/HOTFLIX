								...
								<tr>
									...
									<td>
										<div class="catalog__text">
											<?php echo date('d/m/Y', strtotime($member['birthday'])) ?>
										</div>
									</td>
									<td>
									...
									<td>
										<div class="catalog__text catalog__text--green"><?php echo $member['name_role'] ?>
										</div>
									</td>
									<td>
									...
									<td>
										<div class="catalog__btns">
											...
											<button type="button" data-bs-toggle="modal"
												...
												data-staff-id="<?php echo $member['id_customer'] ?>"
												data-staff-name="<?php echo $member['full_name'] ?>"
			...
			<div class="modal__content">
				<form action="xoa-tai-khoan.html" class="modal__form" method="post">
					...
					<div class="modal__btns">
						...
						<input type="submit" value="Hủy" class="sign__btn sign__btn--small" data-bs-dismiss="modal"
