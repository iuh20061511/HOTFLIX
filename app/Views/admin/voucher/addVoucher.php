    					...
    					<div class="row">
    							...
    							<div class="row">
    								<div class="col-12">
    									<div class="sign__group">
    										<input type="text" name="promotion_name" class="sign__input" placeholder="Tên chương trình" value="<?php echo isset($_POST['promotion_name']) ? $_POST['promotion_name'] : ''; ?>">
    								...
    								<div class="col-12">
    									<div class="sign__group">
    										...
    										<input type="date" class="sign__input" name="date_start" value="<?php echo isset($_POST['date_start']) ? $_POST['date_start'] : ''; ?>">
    								...
    								<div class="col-12">
    									<div class="sign__group">
    										<textarea id="text" name="description" class="sign__textarea" placeholder="Mô tả"><?php echo isset($_POST['description']) ? $_POST['description'] : ''; ?></textarea>
    								...
    								<div class="col-12">
    									<div class="sign__group">
    										...
    										<ul class="sign__radio">
    											<li>
    												<input id="type2" type="radio" name="discount_type" value="1" checked="">
    												<label for="type2">%</label>
    											</li>
    											<li>
    												<input id="type3" type="radio" name="discount_type" value="2">
    								...
    								<div class="col-12">
    									<div class="sign__group">
    										<input type="number" class="sign__input" name="discount_value" placeholder="Giá trị giảm giá" value="<?php echo isset($_POST['discount_value']) ? $_POST['discount_value'] : ''; ?>">
    						...
    						<div class="col-12 col-xl-5">
    							<div class="row">
    								<div class="col-12">
    									<div class="sign__group">
    										<input type="text" class="sign__input" name="promotion_code" placeholder="Mã CODE" value="<?php echo isset($_POST['promotion_code']) ? $_POST['promotion_code'] : ''; ?>">
    								...
    								<div class="col-12">
    									<div class="sign__group">
    										...
    										<input type="date" class="sign__input" name="date_end" value="<?php echo isset($_POST['date_end']) ? $_POST['date_end'] : ''; ?>">
    						...
    						<div class="col-12">
    							<input type="submit" value="Thêm VOUCHER" class="sign__btn sign__btn--small mt-3" name="addPromotion">
    						</div>
    					</div>
    				</form>
    			</div>
