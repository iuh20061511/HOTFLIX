				...
				<div class="col-12">
					<form action="#" class="sign__form sign__form--add" method="post" enctype="multipart/form-data">
						<div class="row">
								...
								<div class="row">
									<div class="col-12">
										<div class="sign__group">
											<input type="text" name ="item_name" class="sign__input" placeholder="Tên mặt hàng" value="<?php echo isset($_POST['item_name']) ? $_POST['item_name'] : ''; ?>">
                                    ...
                                    <div class="col-12">
										<div class="sign__group">
											<input type="number" class="sign__input" name="price" placeholder="Giá cả" value="<?php echo isset($_POST['price']) ? $_POST['price'] : ''; ?>">
							...
							<div class="col-12">
								<input type="submit" value="Thêm mặt hàng" class="sign__btn sign__btn--small mt-3" name="addItem">
							</div>
						</div>
					</form>
				</div>
