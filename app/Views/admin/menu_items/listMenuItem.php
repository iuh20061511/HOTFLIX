			...
			<div class="row">
				...
				<div class="col-12">
					<div class="main__title">
						...
						<span class="main__title-stat">Số lượng mặc hàng: <?php echo $pagination['totalItems'];?></span>
				...
				<div class="col-12">
					<div class="main__paginator">
						<!-- Số lượng hiển thị -->
						<span class="main__paginator-pages invisible"><?= $pagination['itemsPerPage']; ?> of <?= $pagination['totalItems']; ?></span>
