						...
						<div class="row">
							...
							<div class="col-12 col-xl-5">
								<div class="row">
									...
									<div class="col-12" style="margin-top: 15px">
										<div class="sign__group">
												<input type="number" class="sign__input" placeholder="Số lượng ghế ngồi của phòng" name="number_seat" value="<?php echo isset($_POST['number_seat']) ? $_POST['number_seat'] : $listRoom[0]['number_seat']; ?>">
                                                <div>
