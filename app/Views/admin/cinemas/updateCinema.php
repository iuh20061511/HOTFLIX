						...
						<div class="row">
							<div class="col-12">
								...
								<div class="row">
									...
									<div class="col-12">
										<div class="sign__group">
											<textarea id="text" name="description" class="sign__textarea" placeholder="Mô tả - Thông tin thêm về rạp"><?php echo isset($_POST['description']) ? $_POST['description'] : $listCinema[0]['description']; ?></textarea>
