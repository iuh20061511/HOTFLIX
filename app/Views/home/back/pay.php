                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Mã khuyến mãi" name="promoCode">
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <p class="d-flex justify-content-between"><strong>Giảm giá</strong> <span
                                class="text-danger" id="total-price"><?php if (isset($_SESSION['back']['total_discount'])) {
                                                                            echo   $_SESSION['back']['total_discount'];
                                                                        } else {
                                                                            echo "0 ₫";
                                                                        } ?></span></p>
                        <p class="d-flex justify-content-between"><strong>Tiền phải trả</strong> <span
                                class="text-danger" id="total-price"><?php if (isset($_SESSION['back']['total_after_discount'])) {
                                                                            echo   $_SESSION['back']['total_after_discount'];
                                                                        } else {
                                                                            echo $_SESSION['back']['total'];
                                                                        }  ?></span></p>
                        <div class="d-flex justify-content-between">
                            ...
                            <input type="hidden" name="discount" value="<?php if (isset($_SESSION['back']['total_discount'])) {
                                                                            echo   $_SESSION['back']['total_discount'];
                                                                        } else {
                                                                            echo "0";
                                                                        } ?>">

                            <input type="hidden" name="total_after_discount" value="<?php if (isset($_SESSION['back']['total_after_discount'])) {
                                                                                        echo   $_SESSION['back']['total_after_discount'];
                                                                                    } else {
                                                                                        echo $_SESSION['back']['total'];
                                                                                    } ?>">
