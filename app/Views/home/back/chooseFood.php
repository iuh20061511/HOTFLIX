                    ...
                    <div class="card ">
                        ...
                        <table>
                            <th> <img src="<?php echo _WEB_ROOT ?>/public/admin/img/movies/<?php echo  $_SESSION['back']['image']  ?>"
                                ...
                                <input type="hidden" name="image" value="<?php echo  $_SESSION['back']['image']   ?>">
                            </th>
                            <th>
                                <div class="m-3">
                                    <h5 class="card-title"><?php echo $_SESSION['back']['movie_name']  ?><span

                                            class="age-rating">T16</span></h5>
                                    <input type="hidden" name="movie_name" value="<?php echo $_SESSION['back']['movie_name']  ?>">
                                    <p class="card-text"><?php echo $_SESSION['back']['projection_format'] ?></p>
                                    <input type="hidden" name="projection_format" value="<?php echo $_SESSION['back']['projection_format'] ?>">
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <input type="hidden" name="cinema" value="<?php echo $_SESSION['back']['cinema']  ?>">
                            ...
                            <p class="d-flex justify-content-between" id="total-price-display">
                                ...
                                <span class="text-danger" id="total-price"><?php echo $_SESSION['back']['total'] ?> VNĐ</span>


                            </p>
                            <input type="hidden" id="total-input" name="total" value="<?php echo $_SESSION['back']['total']  ?>" />
