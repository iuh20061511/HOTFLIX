    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-xl-6 ">
                <div class="col-12">
                    <?php
                    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id_cinema'])) {
                        $_SESSION['id_cinema_customer'] = $_POST['id_cinema'];
                    }
                    ?>
                    <form action="" method="post">
                        <select name="id_cinema" id="" class="form-control m-2" onchange="this.form.submit()">
                ...
                <div class="d-flex mt-3">
                    ...
                    $today = new DateTime();
                    $today->setTime(0, 0, 0);
                    $fridayThisWeek = clone $today;
                    $fridayThisWeek->modify('this friday');
                    $daysOfWeek = [
                        1 => 'Thứ 2',
                        2 => 'Thứ 3',
                        3 => 'Thứ 4',
                ...
                foreach ($groupedShowTimes as $format => $times) { ?>
                    <span class="text-light"><?php echo $format ?></span>
                    <?php
                    foreach ($times as $time) {
                        echo "<li>ID: " . $time['id_showTime'] . ", Date: " . $time['show_date'] . ", Start Time: " . $time['start_time'] . "</li>";
                    }
                    ?>
                <?php
                }
