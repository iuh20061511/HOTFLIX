    ...
    <body>
        <div class='container'>
            <div class='header'>
                ...
                <h1 style='color:#ff55a5'>Vé tặng</h1>
                <p>$fullnameSender đã dành tặng cho bạn vé xem phim</p>
                <p>Vào phần lịch sử vé để xem hoặc</p>
            </div>
            <div>
                <a href='" . htmlspecialchars($link_invoice) . "' class='download-invoice'>
                    Tải vé tại đây
                </a>
            </div>
            ";
